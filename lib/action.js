...
import { ADD_POST_API, UPDATE_POST_API, DELETE_POST_API, ADD_IMAGE_API, UPDATE_PRODUCT_API,
        GET_POST_API, ADD_PRODUCT_API, GET_PRODUCT_API, DELETE_IMAGE_API } from '@/config/api';
...
export async function addProduct(files, description, initialPrice, salePrice, email, condition) {
  try {
    const accessToken = await redis.get('accessToken');
